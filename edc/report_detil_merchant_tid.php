...
=$edcmerchant_mdroffus=$edcmerchant_creadt=$edcmerchant_upddt=$edcmerchant_creausr=$edcmerchant_updusr=$edcmerchant_replace=$edcmerchant_status=$tid=$provider_desc=
$edcbrand_id=$edcbrand_nama=$branch_mbcode=$branch_mbname=$branch_code=$branch_name=$edcsp_no=$jenisusaha_desc=$edcmerchant_brizzi=$edcmerchant_jaringan=
$edcmerchant_snsimcard="";
...
$select_prep = "SELECT edcmerchant_id,edcmerchant_tid,edcmerchant_mid,edcmerchant_tipe,edcmerchant_kodekanca,edcmerchant_nama,edcmerchant_brand,edcmerchant_sn,               
						edcmerchant_provider,edcmerchant_opendate,edcmerchant_dataadded,edcmerchant_alamat,edcmerchant_kota,edcmerchant_norek,edcmerchant_pic,edcmerchant_pictelp          
						,edcmerchant_FO,edcmerchant_tglimplementasi,edcmerchant_tglinisiasi,edcmerchant_keterangan,edcmerchant_mcc,edcmerchant_mdronus          
						,edcmerchant_mdroffus,edcmerchant_creadt,edcmerchant_upddt,edcmerchant_creausr,edcmerchant_updusr,edcmerchant_replace,edcmerchant_status,
						edcbrand_id,edcbrand_nama,branch_mbcode,branch_mbname,branch_code,branch_name,edcsp_no,jenisusaha_desc,edcmerchant_brizzi,edcmerchant_jaringan,
						provider_desc,edcmerchant_snsimcard
				FROM m_edc_merchant
				LEFT JOIN m_edc_brand ON edcbrand_id = edcmerchant_brand
				LEFT JOIN m_branch ON branch_code = edcmerchant_kodekanca 
			    LEFT JOIN m_edc_sp ON edcsp_id = edcmerchant_sp_id 
				LEFT JOIN m_jenisusaha ON jenisusaha_id = edcmerchant_jenisusaha_id
				LEFT JOIN m_provider ON provider_id = edcmerchant_provider
				WHERE edcmerchant_tid = ? AND edcmerchant_isactive=1 LIMIT 1";
...
if ($select_stmt->num_rows >= 1) {
	...
	$select_stmt->bind_result($edcmerchant_id,$edcmerchant_tid,$edcmerchant_mid,$edcmerchant_tipe,$edcmerchant_kodekanca,$edcmerchant_nama,$edcmerchant_brand,$edcmerchant_sn,
							$edcmerchant_provider,$edcmerchant_opendate,$edcmerchant_dataadded,$edcmerchant_alamat,$edcmerchant_kota,$edcmerchant_norek,$edcmerchant_pic,$edcmerchant_pictelp
							,$edcmerchant_FO,$edcmerchant_tglimplementasi,$edcmerchant_tglinisiasi,$edcmerchant_keterangan,$edcmerchant_mcc,$edcmerchant_mdronus
							,$edcmerchant_mdroffus,$edcmerchant_creadt,$edcmerchant_upddt,$edcmerchant_creausr,$edcmerchant_updusr,$edcmerchant_replace,$edcmerchant_status,
							$edcbrand_id,$edcbrand_nama,$branch_mbcode,$branch_mbname,$branch_code,$branch_name,$edcsp_no,$jenisusaha_desc,$edcmerchant_brizzi,$edcmerchant_jaringan,
							...
							<td align="center" valign="top">
								<div id="tabs">
									<ul>
										...
										<li><a href="#tabs-6" style="font-size: 12px;"><b>Log Activity
													User</b></a></li>
									</ul>
									<div id="tabs-1">
												...
												<td valign="top" width="50%">
													<table width="100%" border="0" cellpadding="1"
														...
														<tr>
															...
															<td class="list_right">: <?php echo $edcmerchant_tid?></td>
														</tr>
														<tr>
															<td class="list_left">MERCHANT ID</td>
															<td class="list_right">: <?php echo $edcmerchant_mid?></td>
														</tr>
														<tr>
															<td class="list_left">UNIT KERJA</td>
															<td class="list_right">: <?php echo $edcmerchant_kodekanca.' - '.$branch_name?></td>
														</tr>
														<tr>
															<td class="list_left">NAMA MERCHANT</td>
															<td class="list_right">: <?php echo $edcmerchant_nama?></td>
														</tr>
														<tr>
															<td class="list_left">ALAMAT</td>
															<td class="list_right">: <?php echo $edcmerchant_alamat?></td>
														</tr>
														
														<tr>
															<td class="list_left">JENIS USAHA</td>
															<td class="list_right">: <?php echo $jenisusaha_desc?></td>
														</tr>
														<tr>
															<td class="list_left">TIPE</td>
															<td class="list_right">: <?php echo $edcmerchant_tipe?></td>
														</tr>
														
														<tr>
															<td class="list_left">PIC/TELP</td>
															<td class="list_right">: <?php echo $edcmerchant_pic?> / <?php echo $edcmerchant_pictelp?></td>
														</tr>
												...
												<td valign="top">
													<table width="100%" border="0" cellpadding="1"
														...
														<tr>
															...
															<td class="list_right">: <?php echo $edcmerchant_sn?></td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td class="list_right">: <?php echo $edcmerchant_tglimplementasi?></td>
														</tr>
														<tr>
															<td class="list_left">TGL INISIASI</td>
															<td class="list_right">: <?php echo $edcmerchant_tglinisiasi?></td>
														</tr>
												...
												<td colspan="2">
													<table width="100%" border="0" cellpadding="1"
														...
														<tr>
															...
															<td class="list_right">: <?php echo $edcmerchant_keterangan?></td>
														</tr>
													</table>
												</td>
											</tr>
									...
									<!-- div id="tabs-2">
										<table width="100%">
											<tr>
												<td>
													<link rel="stylesheet" type="text/css"
														href="http://2.131.177.53/edcmalang/../js-packages/jqchart/jquery.jqChart.css" />
													<link rel="stylesheet" type="text/css"
														href="http://2.131.177.53/edcmalang/../js-packages/jqchart/jquery.jqRangeSlider.css" />

													<script
														src="http://2.131.177.53/edcmalang/../js-packages/jqchart/jquery.mousewheel.js"
														type="text/javascript"></script> <script
														src="http://2.131.177.53/edcmalang/../js-packages/jqchart/jquery.jqChart.min.js"
														type="text/javascript"></script> <script
														src="http://2.131.177.53/edcmalang/../js-packages/jqchart/jquery.jqRangeSlider.min.js"
														type="text/javascript"></script> <!--[if IE]><script lang="javascript" type="text/javascript" src="http://2.131.177.53/edcmalang/../js-packages/jqchart/excanvas.js"></script><![endif]-->
						...
						$('#jqChart_2').jqChart({
							...
							series: [
										...
										<table width="100%" border="0" cellpadding="1" cellspacing="5"
											class="prLBL3"
											style="font: 11px/20px normal Helvetica, Arial, sans-serif !important;">
											<tr>
												<td width="53%">
													<table width="100%">
														<tr>
															<td align="left">
																<p
																	style="font-weight: bold; font-size: 10px; line-height: 16px; margin: 0px;">
																	<i>* click bulan untuk melihat rincian transaksi harian
																		di bulan tersebut</i>
																</p>
															</td>
														</tr>
													...
													<table width="100%" border="1" cellpadding="1"
														...
														<tr>
															<td align="left" style="padding-left: 7px;"><a
																href="http://2.131.177.53/edcmalang/index.php/report_brilink/report_edc_detail_by_tid/21345702/1">
																	Januari </a></td>
														...
														<tr>
															<td align="left" style="padding-left: 7px;"><a
																href="http://2.131.177.53/edcmalang/index.php/report_brilink/report_edc_detail_by_tid/21345702/2">
																	Februari </a></td>
															<td align="right" style="padding-right: 7px;">0</td>
															<td align="right" style="padding-right: 7px;">0</td>
															<td align="right" style="padding-right: 7px;">0</td>
														...
														<tr>
															<td align="left" style="padding-left: 7px;"><a
																href="http://2.131.177.53/edcmalang/index.php/report_brilink/report_edc_detail_by_tid/21345702/3">
																	Maret </a></td>
														...
														<tr>
															<td align="left" style="padding-left: 7px;"><a
																href="http://2.131.177.53/edcmalang/index.php/report_brilink/report_edc_detail_by_tid/21345702/4">
																	April </a></td>
														...
														<tr>
															<td align="left" style="padding-left: 7px;"><a
																href="http://2.131.177.53/edcmalang/index.php/report_brilink/report_edc_detail_by_tid/21345702/5">
																	Mei </a></td>
														...
														<tr>
															<td align="left" style="padding-left: 7px;"><a
																href="http://2.131.177.53/edcmalang/index.php/report_brilink/report_edc_detail_by_tid/21345702/6">
																	Juni </a></td>
														...
														<tr>
															<td align="left" style="padding-left: 7px;"><a
																href="http://2.131.177.53/edcmalang/index.php/report_brilink/report_edc_detail_by_tid/21345702/7">
																	Juli </a></td>
														...
														<tr>
															<td align="left" style="padding-left: 7px;"><a
																href="http://2.131.177.53/edcmalang/index.php/report_brilink/report_edc_detail_by_tid/21345702/8">
																	Agustus </a></td>
														...
														<tr>
															<td align="left" style="padding-left: 7px;"><a
																href="http://2.131.177.53/edcmalang/index.php/report_brilink/report_edc_detail_by_tid/21345702/9">
																	September </a></td>
															<td align="right" style="padding-right: 7px;">11</td>
										...
										<div align="left">
											<p style="font-size: 11px; margin: 0px;">
												Untuk transaksi <b>PLN Prepaid dan Postpaid</b> nominal
												sebenarnya adalah ditambahkan 2 digit "0" di belakang
											</p>
										</div>
