	              			...
	              			<tr>
								<td align="left" valign="middle">
									...
									<?php 
										...
										$orderbySQL = " ORDER BY ";
										$orderby = " edcuko_tglimplementasi ";
										$ascdesc = " desc ";
										...
										if(!empty($_POST["actioncari"]) || !empty($action)){
											if (validateInput($_POST["txtSearch"]) <> "") {
												...
												switch ($post) {
													case "edcuko_tid":
														$criteria .= " WHERE edcuko_tid LIKE ? ";
														break;
													case "edcuko_mid":
														$criteria .= " WHERE edcuko_mid LIKE ? ";
														break;
													/* case "kodeuker":
														$criteria .= " WHERE branch_code LIKE ? ";
														break; */
													case "edcuko_lokasi":
														$criteria .= " WHERE edcuko_lokasi LIKE ? ";
														break;
													case "edcuko_sn":
														$criteria .= " WHERE edcuko_sn LIKE ? ";
														break;
													default:
														;
														break;
									...
									<option value="edcuko_lokasi" <?php if ($post == "edcuko_lokasi") { echo "selected"; }else echo "";?>>Nama Unit Kerja</option>
...
<!-- 									<input type="submit" value=" Cari " id="btnCari" name="btnCari"/> -->
              	...
              	<tr>
              		<td>
              			...
              			$msg .= '<thead>
						        ...
						        <th style="text-align: center;" nowrap>Tgl Inisiasi</th>
				...
				href="javascript:openReportDetilByTID(this.form,'.$edcuko_tid.');" >'.$edcuko_tid.'</a></td>
                							<td style="text-align: center;font-size: 13px;padding-left:7px;padding-right:7px;font-family: Courier New;" nowrap class="td">'.$edcuko_mid.'</td>
											...
											<td style="text-align: left;font-size: 13px;padding-left:7px;padding-right:7px;font-family: Courier New;" nowrap class="td">'.$edcuko_lokasi.'</td>
											...
											<td style="text-align: center;font-size: 13px;padding-left:7px;padding-right:7px;font-family: Courier New;" nowrap class="td">'.$edcuko_sn.'</td>
											<td style="text-align: center;font-size: 13px;padding-left:7px;padding-right:7px;font-family: Courier New;" nowrap class="td">'.$edcuko_tglinisiasi.'</td>
