...
function verifAction(recId){
	...
	if (keterangan != null) {
	    ...
	    actionType.value = "view_verif_uko_edc";
...
if (!empty($_POST["deleteaction"])){
	...
	$delete_prep = "UPDATE m_edc_uko_verif SET keterangan = ? WHERE tid = ? ";
...
<table >
	<tr>
		<td style="padding-left: 30px;padding-right: 30px">
			<div>
			<p style="font-family:monospace;font-weight: bolder;text-align: left;font-size: large; ">Verifikasi EDC UKO</p>
					...
					<tr>
								<!-- td align="left" valign="middle">
									...
									<?php 
										...
										$select_stmt = getEDCUKOVerifikasi($mysqli, $criteria, $txtSearchSQL);
