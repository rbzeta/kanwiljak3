...
function submitSave(recId){
	if(confirm('Anda yakin ingin menyimpan?')){
	    ...
	    saveaction.value = "inputbrilinkedcfinish";
...
$edcbrand_select_id=$edcbrand_select_nama=$provider_id=$provider_id=$provider_desc=$action=$kanca_select_id=$kanca_select_desc=$kanca_select_mbcode=
$jenisusaha_id=$jenisusaha_desc=$edcbrilink_pic=$edcbrilink_pic_notelp=
$saveaction="";
...
if (!empty($_POST["saveaction"])){
	...
	$insert_prep = " INSERT INTO m_edc_brilink
								            (edcbrilink_tid,
								             edcbrilink_mid,
								             edcbrilink_tipe,
	...
	if ($insert_stmt) {
		...
		$insert_stmt->bind_param('sssisisssssissssssss', 
				...
				if (! $insert_stmt->execute()) {
					echo "<script type='text/javascript'>
											...
											redirectPage('input_edc_brilink_finish');
										  </script>";
				}
				}else{
					echo "<script type='text/javascript'>
