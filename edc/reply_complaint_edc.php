...
function replyComplaintByTID(recId){
	var p = document.createElement("input");
	var action = document.createElement("input");
								...
								while ($select_stmt->fetch()){
									...
									$msg .= '<tbody class="table-hover"><tr class="tr">
											...
											<td style="text-align: center;font-size: 13px;padding-left:7px;padding-right:7px;font-family: Courier New;" nowrap class="td">
												<a class="underline" href="javascript:replyComplaintByTID('.$edccomplaint_id.');"><img src="../resource/pen.png" width="11" title="Tindak Lanjut" alt="Tindak Lanjut" /></a></td>								
											<td style="text-align: left;font-size: 13px;padding-left:7px;padding-right:7px;font-family: Courier New;" nowrap class="td">'.date("Y-m-d",strtotime($edccomplaint_creadt)).'</td>
											<td style="text-align: center;font-size: 13px;padding-left:7px;padding-right:7px;font-family: Courier New;" nowrap class="td">
		 						...
		 						<td style="text-align: center;font-size: 13px;padding-left:7px;padding-right:7px;font-family: Courier New;color:#000;'.$statusColor.'" nowrap class="td">'.$status_name.'</td>
                							<td style="text-align: left;font-size: 13px;padding-left:7px;padding-right:7px;font-family: Courier New;" nowrap class="td">'.$edccomplaint_lokasi.'</td>
											...
											<td style="text-align: left;font-size: 13px;padding-left:7px;padding-right:7px;font-family: Courier New;" nowrap class="td">'.$edccomplaint_pic.'</td>';
											
									$rNum += 1;
								}
							}else $msg .= '<tbody class="table-hover"><tr class="tr"><td colspan="6" style="text-align: center;" class="td">Data tidak ditemukan</td></tr></tbody>';
