...
function verifAction(recId){
	...
	if (keterangan != null) {
	    ...
	    actionType.value = "view_verif_merchant_edc";
...
if (!empty($_POST["deleteaction"])){
	...
	$delete_prep = "UPDATE m_edc_merchant_verif SET keterangan = ? WHERE tid = ? ";
...
<table >
	<tr>
		<td style="padding-left: 30px;padding-right: 30px">
			<div>
			<p style="font-family:monospace;font-weight: bolder;text-align: left;font-size: large; ">Verifikasi EDC Merchant</p>
			...
			<hr>
					...
					<tr>
								<!-- td align="left" valign="middle">
									...
									<?php 
										...
										$select_stmt = getEDCMerchantVerifikasi($mysqli, $criteria, $txtSearchSQL);
				...
				<table class="tg" >
				  <tr>
				    ...
				    <th class="tg-b286" style="text-align: left" nowrap>SUPERVISI</th>
