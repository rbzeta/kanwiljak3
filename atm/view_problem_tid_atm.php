...
<table >
	<tr>
		<td style="padding-left: 30px;padding-right: 30px">
			<div>
			<p style="font-family:monospace;font-weight: bolder;text-align: left;font-size: large; ">View ATM Problem By TID</p>
			...
			<hr>
					...
					<tr>
								<td align="left" valign="middle">
									...
									<?php 
										...
										$select_stmt = getViewATMProblemByTID($mysqli, $criteria, $txtSearchSQL);
										 
										
										 
									?>
									<select id="selectSearch" name="selectSearch">
									<option value="atmproblem_tid" <?php if ($post == "atmproblem_tid") { echo "selected"; }else echo "";?>>TID ATM</option>					
				...
				<table class="tg" >
				  <tr>
				    ...
				    <th class="tg-b286" style="text-align: left" nowrap>User</th>
				    <th class="tg-b286" style="text-align: left" nowrap>Date</th>
				    <th class="tg-b286" style="text-align: left" nowrap>Problem</th>
				    <th class="tg-b286" style="text-align: left" nowrap>Keterangan</th>		
				  </tr>
				  <?php
				  if ($select_stmt->num_rows >= 1) {
				  
				  	$select_stmt->bind_result($atmprob_keterangan,
												$atmprob_creadt,
												$atmprob_tid,
												$atmprob_creausr,
				  								$atmprob_status);
					...
					switch ($atmpart_status_id) {
						...
						$msg="";
				  		...
				  		$msg .= '<tr>
									...
									<td class="tg-031e" style="text-align: left">'.$atmprob_tid.'</td>
									<td class="tg-031e" style="text-align: left">'.$atmprob_creausr.'</td>
									<td class="tg-031e" style="text-align: left">'.$atmprob_creadt.'</td>
									<td class="tg-031e" style="text-align: left">'.$atmprob_status.'</td>
									<td class="tg-031e" style="text-align: left">'.$atmprob_keterangan.'</td>
									</tr>';
