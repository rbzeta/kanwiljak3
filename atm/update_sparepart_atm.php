...
function submitSave(form,recordId,select_merk,
		select_part,
		atmpart_sn,
		atmpart_source_tid,
		atmpart_dest_tid,
	...
	if(updateAtmSparepartValidation(form,recordId,select_merk,
			select_part,
			atmpart_sn,
			atmpart_source_tid,
			atmpart_dest_tid,
		...
		if(confirm('Anda yakin ingin menyimpan?')){
		    ...
		    saveaction.value = "update_sparepart_atm";
...
if (!empty($_POST["saveaction"])){
	...
	updateATMSparepartById($mysqli,$tid);
	
}

//get data atm detail
$select_stmt = getATMPartDetailByid($mysqli,$tid);
	...
	<tr>
		<td colspan="1" align="center">
			<div style="margin-top:20px;">
				...
				onclick="submitSave(this.form,<?php echo $atmpart_id?>,
