...
function submitSave(form,recordId,
	...
	if(insertJadwalATMValidation(form,
		...
		if(confirm('Anda yakin ingin menyimpan?')){
		    ...
		    saveaction.value = "update_jadwal_atm";
...
if (!empty($_POST["saveaction"])){
	...
	updateATMJadwalById($mysqli,$tid);
		 
}

//get data jadwal detail
$select_stmt = getJadwalDetailByid($mysqli,$tid);
	...
	<table width="100%"  border="0" cellpadding="00">
      <tr>
        <td align="center" valign="top">
			<div id="tabs">
				<ul>
					<li><a href="#tabs-1" style="font-size:12px;"><b>Update Jadwal</b></a></li>
	...
	<tr>
		<td colspan="1" align="center">
			<div style="margin-top:20px;">
				...
				onclick="submitSave(this.form,<?php echo $atmjadwal_id;?>
