...
function deleteAction(recId){
	if(confirm('Anda yakin ingin menghapus data ?')){
	    ...
	    actionType.value = "view_maintenance_uko_delete";
...
function updateAction(recId){
    ...
    action.name = "action";
    action.type = "hidden";
    action.value = "update_maintenance_uko";
...
if (!empty($_POST["deleteaction"])){
	...
	$delete_prep = "DELETE FROM m_uker_maintenance WHERE ukermaintenance_id = ? ";
...
<div class="right">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
  		<tr>
        	...
        	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
         	 	<tr>
             	 <td align="center" valign="middle"><h3 style="margin-top:0px;"><b>Report Maintenance UKO</b></h3></td>
          		</tr>
        	</table>
    	 </td>
  		</tr>
								...
								<td align="left" valign="middle">
									...
									<?php 
										...
										$select_prep = "SELECT ukermaintenance_id,
																...
																u.user_lname,
																u.user_uker
															FROM m_uker_maintenance
															LEFT JOIN m_user u ON user_id = ukermaintenance_user_id
															LEFT JOIN m_branch ON branch_id = ukermaintenance_branch_id
															LEFT JOIN m_status ON status_id = ukermaintenance_status_id ";
										
										$count_prep = "SELECT COUNT(ukermaintenance_id)
														FROM m_uker_maintenance
															LEFT JOIN m_user u ON user_id = ukermaintenance_user_id
															LEFT JOIN m_branch ON branch_id = ukermaintenance_branch_id
															LEFT JOIN m_status ON status_id = ukermaintenance_status_id ";
										...
										if(!empty($_POST["actioncari"]) || !empty($action)){
											if (validateInput($_POST["txtSearch"]) <> "") {
												...
												if ($logged == "in") {
													$criteria .= " and ukermaintenance_user_id = ".$_SESSION['user_id'];
												...
												if ($logged == "in") {
														...
														$select_prep .= " where ukermaintenance_user_id = ".$_SESSION['user_id'];
														$count_prep .= " where ukermaintenance_user_id = ".$_SESSION['user_id'];
              	...
              	<tr>
              		<td>
              			...
              			$msg .= '<thead>
								...
								<th style="text-align: center;" nowrap>Permasalahan</th>
						        <th style="text-align: center;" nowrap>Tindak Lanjut</th>
						...
						try {	
							$rNum = ($per_page * ($page)) + 1;
 							...
 							if ($select_stmt->num_rows >= 1) {
								...
								$select_stmt->bind_result($ukermaintenance_id,
														$ukermaintenance_date,
														$$ukermaintenance_branch_id,
														$ukermaintenance_problem,
														$ukermaintenance_tindaklanjut,
						...
						<a class="underline" href="javascript:updateAction('.$ukermaintenance_id.');"><img src="../resource/pen.png" width="11" title="edit" alt="edit" /></a>
						<a class="underline" href="javascript:deleteAction('.$ukermaintenance_id.');"><img src="../resource/delete_icon.png" width="11" title="hapus" alt="hapus" /></a></td>';
									}
									$msg .= '<tbody class="table-hover"><tr class="tr">
											<td style="text-align: center;font-size: 13px" class="td">'.$rNum.'</td>
											'.$strActionScript.'
											<td style="text-align: left;font-size: 13px;padding-left:7px;padding-right:7px;font-family: Courier New;" nowrap class="td">'.$ukermaintenance_date.'</td>
            								...
            								<td style="text-align: left;font-size: 13px;padding-left:7px;padding-right:7px;font-family: Courier New;" nowrap class="td">'.$ukermaintenance_keterangan.'</td>
											<td style="text-align: left;font-size: 13px;padding-left:7px;padding-right:7px;font-family: Courier New;" nowrap class="td">'.$ukermaintenance_problem.'</td>
											<td style="text-align: left;font-size: 13px;padding-left:7px;padding-right:7px;font-family: Courier New;" nowrap class="td">'.$ukermaintenance_tindaklanjut.'</td>
											...
											<td style="text-align: left;font-size: 13px;padding-left:7px;padding-right:7px;font-family: Courier New;" nowrap class="td">'.$ukermaintenance_pic.'</td>
                				 			</tr>';
