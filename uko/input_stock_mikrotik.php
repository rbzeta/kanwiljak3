...
function submitSave(form,stockmikrotik_mikrotiksn,
	...
	if(insertStockMikrotikValidation(form,stockmikrotik_mikrotiksn,
			stockmikrotik_modemsn,
			stockmikrotik_simno,
			select_provider,
			select_status,
		...
		if(confirm('Anda yakin ingin menyimpan?')){
		    ...
		    saveaction.value = "input_stock_mikrotik";
...
if (!empty($_POST["saveaction"])){
	...
	$insert_prep = "INSERT INTO m_stock_mikrotik
					(stockmikrotik_mikrotiksn,
					  stockmikrotik_modemsn,
					  stockmikrotik_provider,
					  stockmikrotik_simno,
	...
	if ($insert_stmt) {
		...
		if (! $insert_stmt->execute()) {
			echo "<script type='text/javascript'>
					...
					redirectPage('input_stock_mikrotik_finish');
				  </script>";
		}
	}else{
		echo "<script type='text/javascript'>
