		...
		<table cellpadding="2" width="100%" border="0" cellspacing="0" bgcolor="ff980A">
			<tr><?php 
				if (empty($_SESSION["user_name"])) {
					?>
				<td align="right" ><a href="login.php">User Login</a>	
  			      | <a href="register.php">User Registrasi</a> &nbsp; 
				</td>
					<?php 
				}
			else { ?>
				<td align="left" class="fontLogin">Selamat Datang, <b><?php echo $_SESSION["user_name"]?></b>	
  			      | <a href="logout.php" onclick="return konfirmasi('Anda yakin ingin logout?')">Logout</a> &nbsp; 
				</td>
				<?php } ?>
			</tr>
		</table>
