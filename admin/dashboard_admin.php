...
require '../helper/ADM_DBHelper.php';
...
<div id="body">	
	...
	if ($logged == "in" && $action == "") {
		include 'default_admin.php';
	}elseif ($action == "") include 'default_admin.php';
	
	if ($action != "") {
		switch ($action) {
			case "view_user_admin":
				include 'view_user_admin.php';
				break;
			case "update_user_admin":
				include 'update_user_admin.php';
				break;
			case "update_user_profile":
				include 'update_user_admin.php';
				break;
			case "update_user_admin_finish":
				include 'view_user_admin.php';
				break;
			default:
				include 'default_admin.php';;
