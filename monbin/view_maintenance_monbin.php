...
function deleteAction(recId){
	if(confirm('Anda yakin ingin menghapus data ?')){
	    ...
	    actionType.value = "view_maintenance_monbin_delete";
...
if (!empty($_POST["deleteaction"])){
	...
	$delete_prep = "UPDATE m_tsi_monbin SET tsimonbin_status = 2 WHERE tsimonbin_id = ? ";
...
<div class="right">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
  		<tr>
        	...
        	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
         	 	<tr>
             	 <td align="center" valign="middle"><h3 style="margin-top:0px;"><b>Monitoring dan Pembinaan TSI Kanwil Jakarta 3</b></h3></td>
          		</tr>
        	</table>
    	 </td>
  		</tr>
