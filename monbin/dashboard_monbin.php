...
<div id="body">	
	<?php 
	if ($logged == "in") {
		include 'sidebar_monbin.php';;
	}else include 'sidebar_monbin.php';
	
	
	
	if ($logged == "in" && $action == "") {
		include 'view_maintenance_monbin.php';
	}elseif ($action == "") include 'view_maintenance_monbin.php';
	
	if ($action != "") {
		switch ($action) {
			case "view_maintenance_monbin":
				include 'view_maintenance_monbin.php';
				break;
			case "input_maintenance_monbin":
				include 'input_maintenance_monbin.php';
				break;
			case "success_save_master_monbin":
				include 'view_maintenance_monbin.php';
				break;
			case "open_list_uker_monbin":
				include 'open_list_uker_monbin.php';
				break;
			default:
				include 'view_maintenance_monbin.php';;
				break;
